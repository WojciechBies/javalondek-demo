...
* git flow - w skrócie
    ...
    * przed mergem brancha feature'owego do jednego z glownych (develop lub master) najpierw zmerguj glowny do
    obecnego (wymuszony commit mergujacy)
    * pozniej na glownym branchu mozemy zmergowac ten featurowy za pomoca fast forward
* branch
